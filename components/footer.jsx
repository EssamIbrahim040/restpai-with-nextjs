        ...
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              Implementing the API concept uding NEXTJS with Tailwind css
              </p>
              <div className="flex mt-8 space-x-6 text-gray-600">
                <a
                  className="hover:opacity-75"
                  href="https://www.facebook.com/EssamTurkoman/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="hover:opacity-75"
                  href="https://www.instagram.com/essamibrahim040/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="hover:opacity-75"
                  href="https://github.com/essamibrahim040"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                  ...
                  <Link className="hover:opacity-75" href="/blog">
          ...
          <p className="mt-8 text-xs text-gray-800">© 2024 Essam Tech</p>
        </div>
      </footer>
    </>
  );
